...
```{bash,results='hide',message=FALSE, warning=FALSE}
plink2 --bfile ./02_activities/data/gwa.qc.A2_pruned --king-cutoff 0.0884 --out ./02_activities/data/gwa.A2
```

Answer: ./02_activities/data/gwa.A2.king.cutoff.in.id file is the unrelated individuals
...
```{bash,results='hide',message=FALSE, warning=FALSE}
plink2 --bfile ./02_activities/data/gwa.qc.A2 --keep ./02_activities/data/gwa.A2.king.cutoff.in.id --make-bed --out ./02_activities/data/gwa.qc_unrelated.A2
```
...
```{bash,results='hide',message=FALSE, warning=FALSE}
plink2 --bfile ./02_activities/data/gwa.qc_unrelated.A2 --ci 0.95 --glm --covar ./02_activities/data/gwa.A2_unrel_PCA.eigenvec --covar-name PC1,PC2,PC3 --adjust --out ./02_activities/data/gwa.qc.A2_assoc
```
...
assoc <- data.table::fread("./02_activities/data/gwa.qc.A2_assoc.PHENO1.glm.linear")
